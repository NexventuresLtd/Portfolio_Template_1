            ...
            <div className="w-full md:max-w-11/12 mx-auto px-0">
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="flex-shrink-0 flex items-center">
                        ...
                        <span className={`ml-2 text-xl font-bold ${isScrolled ? (theme === 'dark' ? 'text-primary' : 'text-white') : 'text-white'
                            }`}>
                    ...
                    <div className="flex items-center ">
                        ...
                        <div className="hidden lg:block relative language-selector">
                            <button
                                ...
                                className={`flex items-center space-x-1 px-3 py-2 rounded-lg transition-all duration-200 ${isScrolled
                                        ? (theme === 'dark' ? 'text-primary hover:bg-secondary/20' : 'text-white hover:bg-accent/20')
                                        : 'text-white hover:bg-white/10'
                                    }`}
                                ...
                                <div className={`absolute top-full right-0 w-48 ${theme === 'dark' ? 'bg-surface' : 'bg-white'} shadow-xl rounded-lg ${theme === 'dark' ? 'border-color' : 'border-gray-200'} border py-2 mt-1`}>
                                    {languages.map((language) => (
                                        <button
                                            ...
                                            className={`w-full text-left px-4 py-2 text-sm transition-colors duration-200 flex items-center space-x-3 ${lang === language.code
                        ...
                        <button
                            ...
                            className={`lg:hidden p-2 rounded-md ${isScrolled ? (theme === 'dark' ? 'text-primary' : 'text-white') : 'text-white'
                                }`}
                        >
                    ...
                    <div className="px-2 pt-2 pb-3 space-y-1">
                        {navItems.map((item) => (
                            <div key={item.name} className="dropdown-container">
                                <a
                                    href={item.href}
                                    className={`block px-3 py-2 rounded-md text-base font-medium transition-colors duration-200 ${theme === 'dark'
                                    ...
                                    <div className="pl-4 py-1 space-y-1">
                                        {item.dropdownItems?.map((dropdownItem) => (
                                            <a
                                                key={dropdownItem.name}
                                                href={dropdownItem.href}
                                                className={`block px-3 py-2 rounded-md text-sm transition-colors duration-200 ${theme === 'dark'
                                                        ? 'text-primary hover:text-secondary hover:bg-secondary/20'
                                                        : 'text-primary hover:text-accent hover:bg-accent/10'
                                                    }`}
                        ...
                        <div className="px-3 py-2">
                            ...
                            <select
                                ...
                                className={`ml-2 px-2 py-1 text-sm rounded border ${theme === 'dark'
